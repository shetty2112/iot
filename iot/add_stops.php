...
<div id="wrapper">
  ...
  <div id="page-wrapper">
    <div class="container-fluid">
      <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
          <h4 class="page-title">Add New Bus Stop</h4>
        </div>
        </div>
   ...
   <div class="col-md-12">
   <form class="form-material form-horizontal" action="add_stop_back.php" method="POST" enctype="multipart/form-data" onsubmit="validateform()" >
				
				 
			<div class="form-group">
            <div class="col-md-2">
            <label for="event_title">Stop Name<span class="text-danger">*</span></label></div>
                <div class="col-md-3">
			...
			<div class="form-group">
				<div class="col-md-2">
            <label for="event_title">Stop Value<span class="text-danger">*</span></label></div>
                <div class="col-md-3">
                   <input type="Number" class="form-control" id="value" name="value" placeholder="Vlaue" required><br>
			    </div>
            </div>	
