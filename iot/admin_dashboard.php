...
<div style="float:Left" >
 ...
 <form align="Left"  method="post" action="add_balance.php">
  ...
  <button type="submit" class="button" ><span> Add Balance</span> </button><br>
   ...
   <form align="Left"  method="post" action="history.php">
  <input type="hidden" name="table" value="1"><br>
  <button type="submit" class="button" ><span>Transaction History </span> </button><br>
 </form>
...
$select_path="SELECT * FROM `booking` WHERE customer_id = '$c_id'";
...
?>
    ...
    <td><p><?php echo $start_point; ?></p></td>
    <td><p><?php echo $end_point; ?></p></td>
