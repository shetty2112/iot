    ...
    <div class="btn-group m-r-12">
      <button aria-expanded="false" data-toggle="dropdown" class="btn btn-info dropdown-toggle waves-effect waves-light" type="button">Options <span class="caret"></span></button>
       ...
       <ul role="menu" class="dropdown-menu">    
        ...
        <li><a href="reset_customer_pass.php?c_id=<?php echo $row3['c_id'];?>">Reset Password</a>
        <li><a href="delete_customer_pass.php?c_id=<?php echo $row3['c_id'];?>">Delete Customer</a>
        <li><a href="edit_customer.php?c_id=<?php echo $row3['c_id'];?>">Add Finger ID</a>
