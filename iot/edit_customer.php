...
<div id="wrapper">
  ...
  <div id="page-wrapper">
   ...
   <div class="col-md-12">
   <form class="form-material form-horizontal" action="edit_customer_back.php" method="POST" enctype="multipart/form-data" >
            ...
            <label for="event_title">Name<span class="text-danger">*</span></label></div>
                <div class="col-md-3">
                   <input type="text" class="form-control" id="first_name" name="name" value="<?php echo $name; ?>" required><br>
			    </div>
            </div>
      ...
      <input type="hidden" name="c_id" value="<?php echo $c_id; ?>">
            ...
            <label for="event_title">Mobile Number<span class="text-danger">*</span></label></div>
                <div class="col-md-3">
                   <input type="Number" class="form-control" id="mobile_number" name="mobile_number" value="<?php echo $contact; ?>" required><br>
			    </div>
            </div>	
            ...
            <label for="event_title">Email<span class="text-danger">*</span></label></div>
                <div class="col-md-3">
                   <input type="email" class="form-control" id="phone" name="email" value="<?php echo $email; ?>" required><br>
			    </div>
            </div>		
            ...
            <label for="event_title">Address<span class="text-danger">*</span></label></div>
                <div class="col-md-3">
                   <input type="text" class="form-control" id="address" name="address" value="<?php echo $address; ?>" required><br>
			    </div>
            </div>	

        <div class="form-group">
        <div class="col-md-2">
            <label for="event_title">Finger ID<span class="text-danger">*</span></label></div>
                <div class="col-md-3">
                   <input type="text" class="form-control" id="f_id" name="f_id" value="<?php echo $f_id; ?>" required><br>
          </div>
            </div>
