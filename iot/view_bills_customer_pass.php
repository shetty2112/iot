    ...
    <div class="container-fluid">
      <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
          <h4 class="page-title">All Bills list</h4>
        </div>
        <!-- /.col-lg-12 -->
      </div>
      <!-- .row -->
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title">All Bills list</h4>
                  </div>
...
<?php
      ...
      $query = "SELECT * FROM `bills` WHERE c_id ='$c_id' ";
                  ...
                  while( $row3 = mysqli_fetch_assoc( $result1 ) )
                      {
                          ...
                          $date = date('Y-m-d', $time);
                             ...
                             $sql2="SELECT * FROM booking WHERE id='$b_id'";
                             ...
                             while($row=mysqli_fetch_assoc($result2))
                             {
                               ...
                               $start_date=$row['start_date'];
                                 ...
                                 $sql3="SELECT * FROM customer WHERE c_id='$customer_id'";
