    ...
    <div class="container-fluid">
      <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
          <h4 class="page-title">All Customer list</h4>
        </div>
        <!-- /.col-lg-12 -->
      </div>
      <!-- .row -->
...
<?php
       $query = "SELECT * FROM `booking` WHERE status = '0' AND customer_id = '$c_id'";
                  ...
                  while( $row3 = mysqli_fetch_assoc( $result ) )
                      {
                        ...
                        $p_number = $row3['p_number'];
                        $r_type = $row3['r_type'];

                        if($r_type == 0 ){$room_type = "Normal";}
                          if($r_type == 1 ){$room_type = "Delux";}
                            if($r_type == 2 ){$room_type = "Super Delux";}
              ...
              <div class="btn-group m-r-12">
                  <button aria-expanded="false" data-toggle="dropdown" class="btn btn-info dropdown-toggle waves-effect waves-light" type="button">Options <span class="caret"></span></button>
                   ...
                   <ul role="menu" class="dropdown-menu"> 
                    ...
                    <li><a href="confirm_booking.php?booking_id=<?php echo $booking_id;?>">Confirm </a>          
                    <li><a href="cancel_booking.php?booking_id=<?php echo $booking_id;?>">Cancel</a>
